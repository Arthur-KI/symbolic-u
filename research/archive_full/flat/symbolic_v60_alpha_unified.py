...
Path("/mnt/data/symbolic_v60_alpha_unified_report.json").write_text(
    json.dumps(report,ensure_ascii=False,indent=2),encoding="utf-8"
)
with Path("/mnt/data/symbolic_v60_alpha_unified_checks.csv").open("w",newline="",encoding="utf-8") as f:
