...
Path("/mnt/data/symbolic_v50a_regression_rerun_copy.py").write_text(
    Path(__file__).read_text(encoding="utf-8") if "__file__" in globals() else "",
    encoding="utf-8"
)
Path("/mnt/data/symbolic_v50a_regression_rerun_report.json").write_text(
    json.dumps(report,ensure_ascii=False,indent=2),encoding="utf-8"
)
with Path("/mnt/data/symbolic_v50a_regression_rerun_checks.csv").open("w",newline="",encoding="utf-8") as f:
    w=csv.writer(f)
